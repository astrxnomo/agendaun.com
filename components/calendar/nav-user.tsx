import { ArrowUpDown, LogOut, Sparkle, User } from "lucide-react"
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <ArrowUpDown className="text-muted-foreground/80 ml-auto size-5" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
          ...
          >
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem className="focus:bg-sidebar-accent gap-3">
                <LogOut size={20} className="text-muted-foreground/80 size-5" />
                Logout
              </DropdownMenuItem>
            </DropdownMenuGroup>
          </DropdownMenuContent>
